 ...
 *   - tests/scenarios/runner.ts  (test runner, this PR)
 *   - PR #4: browser-side QA viewer (will import from here)
 *
 * No PixiJS, no DOM, no Math.random(), no wall-clock reads.
 */

import type { SimState, SimEvent } from "../../src/sim/index.js";
import type { PlayerCommand } from "../../src/sim/combat/tick.js";
import type { CombatScenario } from "../../src/sim/index.js";
import type { DepthBand, SpeedSetting, SpeedDirection } from "../../src/sim/combat/types.js";
